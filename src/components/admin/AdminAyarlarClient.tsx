                ...
                {[1, 2, 3, 4].map(n => (
                  <div key={n} style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '12px' }}>
                    ...
                    <div>
                      ...
                      <textarea name={`service_${n}_desc`} value={(form as any)[`service_${n}_desc`] || ''} onChange={handleChange} rows={2} style={{ ...inputStyle, resize: 'vertical' }} onFocus={focusGold} onBlur={blurSubtle} />
                    </div>
                  </div>
                ))}
              </div>
