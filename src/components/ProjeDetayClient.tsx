      ...
      <section style={{
        ...
        {project.coverImage ? (
          <>
            ...
            <div style={{
              position: 'absolute', inset: 0,
              background: 'linear-gradient(to top, rgba(10,12,15,0.9) 0%, rgba(10,12,15,0.3) 100%)',
            }} />
          </>
        ) : (
          <>
                ...
                {[
                  ...
                  <div key={detail.label} style={{
                    ...
                    <span style={{
                      ...
                      fontSize: detail.label === 'Yil' || detail.label === 'Alan' ? '20px' : '15px',
                      ...
                      <div className="rel-inner" style={{
                        ...
                        {rel.coverImage ? (
                          ...
                          <div style={{
                            ...
                            background: `radial-gradient(ellipse at ${i * 30}% 60%, rgba(201,168,76,0.08) 0%, transparent 60%), linear-gradient(135deg, var(--dark-3) 0%, var(--dark-4) 100%)`,
                          }}>
                            <span style={{
                              fontFamily: 'var(--font-cormorant), serif',
