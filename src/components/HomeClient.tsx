    ...
    <div ref={ref}>
      <Link href={`/projeler/${project.slug}`} style={{ textDecoration: 'none', display: 'block' }}>
        ...
        >
          ...
          <div className="card-inner" style={{
            ...
            {project.coverImage ? (
              ...
              <div style={{
                ...
                background: `
                  radial-gradient(ellipse at ${index === 0 ? '30%' : index === 1 ? '70%' : '50%'} 40%,
          ...
          <div style={{
            position: 'absolute', inset: 0,
            background: 'linear-gradient(to top, rgba(10,12,15,0.92) 0%, rgba(10,12,15,0.3) 40%, transparent 70%)',
          }} />
...
<section style={{
  ...
  {/* Karartma overlay — video/görsel varsa daha koyu */}
  <div style={{
    position: 'absolute', inset: 0,
    background: settings.hero_video_url || settings.hero_image_url
      ...
      : `
        radial-gradient(ellipse at 70% 50%, rgba(201,168,76,0.07) 0%, transparent 50%),
        radial-gradient(ellipse at 20% 80%, rgba(201,168,76,0.04) 0%, transparent 40%),
        linear-gradient(135deg, #0A0C0F 0%, #111318 50%, #0A0C0F 100%)
      `,
    zIndex: 1,
  }} />

  {/* Grid — sadece medya yoksa göster */}
  ...
  {/* Dekoratif çizgiler — sadece medya yoksa */}
  {!settings.hero_video_url && !settings.hero_image_url && (
    <>
      <div style={{
      ...
      <div style={{
        position: 'absolute', right: '5%', top: '50%', zIndex: 1,
      ...
      <div style={{
        ...
        borderRadius: '50%', border: '1px solid rgba(201,168,76,0.1)', pointerEvents: 'none',
      }} />
      <div style={{
        position: 'absolute', right: '-20px', top: '50%', zIndex: 1,
        transform: 'translateY(-50%)',
        fontFamily: 'var(--font-cormorant), serif',
  ...
  <div className="container-site" style={{ position: 'relative', zIndex: 2, paddingTop: '120px' }}>
    <div style={{ maxWidth: '680px' }}>
      ...
      <h1 className="animate-fade-up delay-100" style={{
        ...
        letterSpacing: '-0.02em', color: 'var(--text-primary)', marginBottom: '32px',
      }}>
        {settings.hero_title ? (
          <>
            {settings.hero_title.split(' ').slice(0, -1).join(' ')}<br />
            <em style={{ fontStyle: 'italic', color: 'var(--gold)' }}>
              {settings.hero_title.split(' ').slice(-1)[0]}
            </em>
          </>
        ) : (
          <>
            Güven Üzerine<br />
            <em style={{ fontStyle: 'italic', color: 'var(--gold)' }}>İnşa Edilmiş.</em>
          </>
        )}
      </h1>
      ...
      <p className="animate-fade-up delay-200" style={{
        ...
        maxWidth: '460px', marginBottom: '56px',
      }}>
  ...
  <div className="animate-fade-in delay-600" style={{
    position: 'absolute', bottom: '40px', left: '50%', zIndex: 2,
        ...
        <RevealSection key={stat.label} delay={i * 0.1}>
          <div style={{ textAlign: 'center' }}>
            <p style={{
              ...
              fontWeight: 300, color: 'var(--gold)', lineHeight: 1, marginBottom: '8px',
            }}>{stat.value}</p>
            <p style={{
              fontSize: '11px', fontWeight: 500,
          ...
          <RevealSection>
            <div style={{ marginBottom: '64px' }}>
              ...
              <h2 style={{
                ...
                Konut & Ticari<br />
                <em style={{ fontStyle: 'italic', color: 'var(--gold)' }}>Mükemmeliyetle Teslim</em>
              </h2>
            </div>
          </RevealSection>
          <div style={{
            ...
            {[
              { num: '01', title: 'Konut İnşaatı', desc: 'Villadan rezidansa, her ölçekte prestijli konut projeleri.' },
              { num: '02', title: 'Ticari Yapılar', desc: 'Ofis binaları, AVM ve endüstriyel tesisler.' },
              { num: '03', title: 'İç Mimari', desc: 'Anahtar teslim iç tasarım ve uygulama hizmetleri.' },
              { num: '04', title: 'Renovasyon', desc: 'Mevcut yapıların modern standartlara yükseltilmesi.' },
            ].map((service, i) => (
