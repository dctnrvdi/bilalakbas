...
async function main() {
  ...
  const settings = [
    ...
    { key: 'about_text', value: '2010 yilinda Istanbulda kurulan Bilal Akbaş, konut ve ticari insaat alaninda kalite ve guvenilirligin sembolu haline geldi.' },
    { key: 'contact_phone', value: '+90 212 000 00 00' },
    { key: 'contact_email', value: 'info@bilalakbas.com' },
    ...
    { key: 'footer_email', value: 'info@bilalakbas.com' },
